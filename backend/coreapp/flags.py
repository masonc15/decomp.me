...
COMMON_ARMCC_FLAGS = FlagClass(
    ...
    flags=[
        FlagSet(
            id="armcc_opt_level",
            flags=["-O0", "-O1", "-O2", "-O3", "-Ospace", "-Otime"],
        ),
        LanguageFlagSet(
            id="armcc_language",
...
COMMON_CLANG_FLAGS = FlagClass(
    name="clang",
    flags=[
        FlagSet(
            id="clang_opt_level",
            flags=["-O0", "-O1", "-O2", "-O3", "-Ofast", "-Os", "-Oz"],
        ),
...
COMMON_SHC_OLD_FLAGS = FlagClass(
    name="shc-old",
    flags=[
        ...
        FlagSet(
            id="shc_extra",
            flags=["-extra=asm=800", "-extra=asm=1000", "-extra=asm=1800"],
        ),
...
COMMON_GCC_FLAGS = FlagClass(
    ...
    flags=[
        ...
        FlagSet(
            id="gcc_debug_level",
            flags=["-gdwarf-2", "-gdwarf", "-g0", "-g1", "-g2", "-g3"],
        ),
...
COMMON_DIFF_FLAGS = FlagClass(
    name="common",
    flags=[
        FlagSet(
            id="diff_algorithm",
            flags=[
                ASMDIFF_FLAG_PREFIX + "levenshtein",
                ASMDIFF_FLAG_PREFIX + "difflib",
            ],
        ),
        Checkbox(
            "diff_function_symbols", ASMDIFF_FLAG_PREFIX + "diff_function_symbols"
        ),
        IntOrHexParameterFlag("adjust_vma", "--adjust-vma"),
    ],
)

COMMON_MIPS_DIFF_FLAGS = FlagClass(
    name="mips",
    flags=[
        FlagSet(
            id="mips_mreg_names",
...
COMMON_GHS_FLAGS = FlagClass(
    ...
    flags=[
        ...
        FlagSet(
            id="ghs_inlining_mode",
            flags=["--max_inlining", "--inlining", "--no_inlining"],
        ),
...
OTHER_FLAGS = FlagClass(name="other", flags=[])
